...
public class AssignUserToRoleCommandHandler(ILogger<AssignUserToRoleCommandHandler> logger,
    UserManager<User> userManager,
    RoleManager<IdentityRole> roleManager) : IRequestHandler<AssignUserToRoleCommand>
{
